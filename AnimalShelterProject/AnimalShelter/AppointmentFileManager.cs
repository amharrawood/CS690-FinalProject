...
namespace AnimalShelter
{
    public class AppointmentFileManager
    {
        ...
        //public AppointmentSearch FindAppointment(string name)
        //{
        //    return LoadAppointments().FirstOrDefault(a => a.AnimalName.Equals(name, StringComparison.OrdinalIgnoreCase));
        //}
    }
}